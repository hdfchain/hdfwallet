...
//
//   https://github.com/hdfchain/hdfwallet/blob/master/rpc/documentation/api.md
//
// Any API changes must be performed according to the steps listed here:
//
//   https://github.com/hdfchain/hdfwallet/blob/master/rpc/documentation/serverchanges.md
package rpcserver
...
import (
	...
	"encoding/hex"
	"fmt"
	"github.com/hdfwallet-wallet-v3.2.1/wallet"
	"net"
	"sync/atomic"
	"time"
	...
	"github.com/hdfchain/hdfwallet/internal/loader"
	...
	"github.com/hdfchain/hdfwallet/chain/v3"
	"github.com/hdfchain/hdfwallet/errors/v2"
	"github.com/hdfchain/hdfwallet/p2p/v2"
	"github.com/hdfchain/hdfwallet/rpc/client/hdfd"
	pb "github.com/hdfchain/hdfwallet/rpc/walletrpc"
	"github.com/hdfchain/hdfwallet/spv/v3"
	"github.com/hdfchain/hdfwallet/ticketbuyer/v4"
	"github.com/hdfchain/hdfwallet/wallet/v3"
	"github.com/hdfchain/hdfwallet/wallet/v3/txauthor"
	"github.com/hdfchain/hdfwallet/wallet/v3/txrules"
	"github.com/hdfchain/hdfwallet/wallet/v3/udb"
	"github.com/hdfchain/hdfwallet/walletseed"
)
...
// as well as establishing a RPC connection to a hdfd consensus server.
...
func (s *walletServer) GetTicket(ctx context.Context, req *pb.GetTicketRequest) (*pb.GetTicketsResponse, error) {
	...
	// The hdfd client could be nil here if the network backend is not
