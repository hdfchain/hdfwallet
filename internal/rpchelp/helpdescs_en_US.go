...
var helpDescsEnUS = map[string]string{
	...
	"inforesult-relayfee":        "The minimum relay fee for non-free transactions in HDF/KB",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in hdfchain",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in hdfchain",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in hdfchain",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and hdfchain amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in hdfchain",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in hdfchain",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in hdfchain",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in hdfchain",
	...
	"listunspentresult-amount":        "The amount of the output valued in hdfchain",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in hdfchain",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in hdfchain to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in hdfchain",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in hdfchain",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in hdfchain",
	...
	"setticketmaxprice-max":       "The max price (in hdf).",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in hdfchain",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in hdfchain.",
	...
	"getwalletfee--result0":  "Current tx fee (in HDF)",
	...
	"purchaseticket-ticketfee":          "The transaction fee rate (HDF/kB) to use (overrides fees set by the wallet config or settxfee RPC)",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in hdfchain",
