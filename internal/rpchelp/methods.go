...
var Methods = []struct {
	...
	{"getbestblock", []interface{}{(*hdfdtypes.GetBestBlockResult)(nil)}},
	...
	{"listlockunspent", []interface{}{(*[]hdfdtypes.TransactionInput)(nil)}},
	...
	{"version", []interface{}{(*map[string]hdfdtypes.VersionResult)(nil)}},
