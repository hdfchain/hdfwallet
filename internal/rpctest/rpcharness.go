...
// Harness fully encapsulates an active hdfd process, along with an embedded
// hdfwallet to provide a unified platform for creating RPC-driven integration
// tests involving hdfd. The active hdfd node will typically be run in simnet
...
// spends. The active hdfd process is fully managed by Harness, which handles
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// Start hdfwallet. This spawns a new process which will be managed
	...
	// Get a new address from the wallet to be set with hdfd's --miningaddr
...
// hdfd process belonging to this Harness instance. If the initial connection
