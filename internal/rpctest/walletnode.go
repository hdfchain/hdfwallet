...
// walletTestConfig contains all the args, and data required to launch a hdfwallet process
...
// command returns the exec.Cmd which will be used to start the hdfwallet
// process.
...
// to connect to the hdfwallet process that is launched via Start().
...
// process, and as the base for the log and data directories for hdfwallet.
...
// Start creates a new hdfwallet process, and writes its pid in a file reserved
