...
import (
	...
	ldr "github.com/hdfchain/hdfwallet/internal/loader"
	"github.com/hdfchain/hdfwallet/internal/prompt"
	"github.com/hdfchain/hdfwallet/internal/rpc/rpcserver"
...
func run(ctx context.Context) error {
	...
	// the trusted hdfd server.  This blocks until cancelled.
	if !cfg.NoInitialLoad {
		if done(ctx) {
			return ctx.Err()
		}
