...
var certificateFile = filepath.Join(dcrutil.AppDataDir("hdfwallet", false), "rpc.cert")
...
if (os.platform() == 'win32') {
  ...
  certPath = path.join(process.env.HOME, '.hdfwallet', 'rpc.cert');
}
...
```bash
$ protoc -I /path/to/hdfchain/hdfwallet/rpc --python_out=. --grpc_out=. \
