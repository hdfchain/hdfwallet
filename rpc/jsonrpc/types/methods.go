...
type LockUnspentCmd struct {
	Unlock       bool
	Transactions []hdfdtypes.TransactionInput
}

// NewLockUnspentCmd returns a new instance which can be used to issue a
// lockunspent JSON-RPC command.
func NewLockUnspentCmd(unlock bool, transactions []hdfdtypes.TransactionInput) *LockUnspentCmd {
...
func init() {
	...
	register = []registeredMethod{
		{"authenticate", (*hdfdtypes.AuthenticateCmd)(nil)},
		{"createrawtransaction", (*hdfdtypes.CreateRawTransactionCmd)(nil)},
		{"getbestblock", (*hdfdtypes.GetBestBlockCmd)(nil)},
		{"getbestblockhash", (*hdfdtypes.GetBestBlockHashCmd)(nil)},
		{"getblockcount", (*hdfdtypes.GetBlockCountCmd)(nil)},
		{"getblockhash", (*hdfdtypes.GetBlockHashCmd)(nil)},
		{"getinfo", (*hdfdtypes.GetInfoCmd)(nil)},
		{"getpeerinfo", (*hdfdtypes.GetPeerInfoCmd)(nil)},
		{"help", (*hdfdtypes.HelpCmd)(nil)},
		{"ticketsforaddress", (*hdfdtypes.TicketsForAddressCmd)(nil)},
		{"validateaddress", (*hdfdtypes.ValidateAddressCmd)(nil)},
		{"verifymessage", (*hdfdtypes.VerifyMessageCmd)(nil)},
		{"version", (*hdfdtypes.VersionCmd)(nil)},
	}
	for i := range register {
		dcrjson.MustRegister(Method(register[i].method), register[i].cmd, 0)
	}
