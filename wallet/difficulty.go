...
// This code was copied from hdfd/blockchain/difficulty.go and modified for
// hdfwallet's header storage.
...
func (w *Wallet) ancestorHeaderAtHeight(dbtx walletdb.ReadTx, h *wire.BlockHeader, chain []*BlockNode, height int32) (*wire.BlockHeader, error) {
	...
	case height > int32(h.Height), height < 0:
		return nil, nil // hdfd's blockNode.Ancestor returns nil for child heights
	}
