...
import (
	...
	dcrrpcclient "github.com/hdfchain/hdfd/rpcclient"
...
var (
	walletDataDirectory = dcrutil.AppDataDir("hdfwallet", false)
	newlineBytes        = []byte{'\n'}
)
...
// Flags.
var opts = struct {
	TestNet               bool    `long:"testnet" description:"Use the test hdfchain network"`
	SimNet                bool    `long:"simnet" description:"Use the simulation hdfchain network"`
...
func init() {
	...
	if opts.TestNet && opts.SimNet {
		fatalf("Multiple hdfchain networks may not be used simultaneously")
	}
